...
public class ReportService {
  ...
  private boolean isEventLinked(TransactionRow r, Long eventId) {
    ...
    if (r.referenceId() == null)
      return false;
    // If your mapping sometimes uses EVENT_REGISTRATION -> resolve to
    // registration.eventId
    return switch (r.source()) {
      case "Event", "EventRegistration", "VendorPayment", "Bill", "Donation", "UserPayment", "Payment",
          "UserMembership", "Refund" -> {
